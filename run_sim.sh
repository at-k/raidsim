...
$EXE  -d 5 -b 34359738368 -c 1.0 -m c -R 1.10 -C 16 -r 1.25 -i 33554320 >> $RES
$EXE  -d 5 -b 34359738368 -c 1.0 -m c -R 1.15 -C 16 -r 1.25 -i 33554320 >> $RES
$EXE  -d 5 -b 34359738368 -c 1.0 -m c -R 1.20 -C 16 -r 1.25 -i 33554320 >> $RES
$EXE  -d 5 -b 34359738368 -c 1.0 -m c -R 1.25 -C 16 -r 1.25 -i 33554320 >> $RES
$EXE  -d 5 -b 34359738368 -c 1.0 -m c -R 1.30 -C 16 -r 1.25 -i 33554320 >> $RES
$EXE  -d 5 -b 34359738368 -c 1.0 -m c -R 1.35 -C 16 -r 1.25 -i 33554320 >> $RES
$EXE  -d 5 -b 34359738368 -c 1.0 -m c -R 1.40 -C 16 -r 1.25 -i 33554320 >> $RES
$EXE  -d 5 -b 34359738368 -c 1.0 -m c -R 1.45 -C 16 -r 1.25 -i 33554320 >> $RES
$EXE  -d 5 -b 34359738368 -c 1.0 -m c -R 1.50 -C 16 -r 1.25 -i 33554320 >> $RES
